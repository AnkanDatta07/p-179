# -*- coding: utf-8 -*-
"""
Created on Thu Jul 25 14:07:30 2024
...
btn_check = Button(root, text = "CHECK", command = get_textColor, relief = FLAT, bg = "Cyan", fg = "white", padx = 10, pady = 1, font = ("Arial", 15))
btn_check.place(relx = 0.3, rely = 0.8, anchor = CENTER)

btn_start = Button(root, text = "START", command = obj.updateGame, relief = FLAT, bg = "Blue", fg = "white", padx = 10, pady = 1, font = ("Arial", 15))
